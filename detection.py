...
def main(input_directory,classifier_output_path):
    """
    ...
    with tf.Session(config=tf.ConfigProto(log_device_placement=False)) as sess:
        train_set, test_set = _get_test_and_train_set(input_directory, min_num_images_per_label=10,
                                                      split_ratio=0.7)
        '''if is_train:
        ...
        images, labels, class_names = _load_images_and_labels(test_set, image_size=160, batch_size=128,
                                                                  num_threads=16, num_epochs=1)

        
        _load_model(model_filepath="/home/sai/face/medium-facenet-tutorial/medium_facenet_tutorial/model_dir/20170511-185253.pb")
...
if __name__ == '__main__':
    ...
    main(input_directory=args.input_dir, classifier_output_path=args.classifier_path)
